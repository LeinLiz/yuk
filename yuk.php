...
$headers[] = "X-UniqueId: ".time()."57".mt_rand(1000,9999);
$headers[] = "X-Location: -6.246265,106.690718";
$headers[] = "X-Location-Accuracy: 3.0";
        ...
        if($regs->success == true) {
            ...
            if($verifs->success == true) {
                ...
                // SANTAI19
                echo "\e[96m[!] Proses Reedem Voucher 15+10 Minbel 20k : GOFOODYUK \n";
                ...
                if($claims->success == true) 
                        {
                        ...
                        else 
                            {
                                echo "\e[91m [×] Gagal Claim Voucer !";
                                    ...
                                    // SANTAI11
                                        echo "\e[96m[!] Proses Reedem Voucher 15+10 Minbel 30k : PESANGOFOOD \n";
                                        $data4 = '{"promo_code":"PESANGOFOOD"}';
